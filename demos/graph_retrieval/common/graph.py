...
The graph structured recipe metadata explicitly.
That matters for allergy handling because "not allergic to sulfites" is a
filtering problem, unless we enjoy letting vague string matching make
medical-adjacent decisions like a caffeinated raccoon.
